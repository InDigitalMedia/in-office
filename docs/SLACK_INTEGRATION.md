...
- **Daily office digest** — every weekday morning, a message goes to a configured channel: "*:coffee: Good morning everyone! Here's who's in the office today :point_down:*", followed by the day's Neal Street/Client Office breakdown, a "📅 See Full Schedule" button, and a "✏️ Fill My Week" button. Runs as its own scheduled action, independent of the reminder above.
